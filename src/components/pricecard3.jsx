 ...
 function PriceCard3 () {
    ...
    return (
        <motion.div className="scale-85 overflow-hidden w-85 h-150 rounded-3xl shadow-lg ring-1 ring-indigo-600 bg-cover bg-center z-20  p-5 flex flex-col justify-between relative  opacity-0" whileHover= {{scale:1.05}} transition= {{
            duration:0.5
